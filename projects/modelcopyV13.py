...
STAYED_VAL = 2.0
SIGMA_PTS  = 5    # σ des gaussiennes 2D pour les têtes entered/left (pixels)
...
if __name__ == "__main__":
    ...
    SAVE_PATH = os.path.join(os.path.dirname(__file__), "..", "crowd_tracking_net13.pth")
    VIZ_DIR   = os.path.join(os.path.dirname(__file__), "..", "visualizations/13")
