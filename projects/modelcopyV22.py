...
def tracking_loss(
    ...
    w_bg = 8.0, w_stayed = 5.0 : fond plus fortement pénalisé que stayed par pixel,
...
if __name__ == "__main__":
    ...
    SAVE_PATH = os.path.join(os.path.dirname(__file__), "..", "crowd_tracking_net22.pth")
    VIZ_DIR   = os.path.join(os.path.dirname(__file__), "..", "visualizations/22")
