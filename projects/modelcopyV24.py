"""
modelcopyV24.py — CrowdTrackingNet  (tâche simplifiée : stayed uniquement)
===========================================================================
...
def tracking_loss(
    ...
    Solution V23 — 3 masques séparés :
        mask_peak : target ≥ 1.5  — pixels de pic (STAYED_VAL = 2.0)
                    poids w_peak = 30.0 pour forcer pred → 2.0 à ces endroits.
        ...
        mask_bg   : target ≤ 0.05 — fond pur
                    poids w_bg = 8.0 pour supprimer les faux positifs.
...
if __name__ == "__main__":
    ...
    SAVE_PATH = os.path.join(os.path.dirname(__file__), "..", "crowd_tracking_net24.pth")
    VIZ_DIR   = os.path.join(os.path.dirname(__file__), "..", "visualizations/24")
