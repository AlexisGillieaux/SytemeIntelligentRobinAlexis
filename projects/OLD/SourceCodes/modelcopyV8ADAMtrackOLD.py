...
if __name__ == "__main__":
    ...
    SAVE_PATH = os.path.join(os.path.dirname(__file__), "..", "crowd_tracking_net8ADAMtrackOLD.pth")
    VIZ_DIR   = os.path.join(os.path.dirname(__file__), "..", "visualizations/8ADAMtrackOLD")
