"""
modelcopyV25.py — CrowdTrackingNet  (tâche simplifiée : stayed uniquement)
===========================================================================
...
def tracking_loss(
    ...
    Solution V23 — 3 masques séparés :
        ...
        mask_tail : 0.05 < target < 1.5 — queues gaussiennes
                    poids w_tail = 1.0 pour le gradient directionnel vers le centre.
...
if __name__ == "__main__":
    ...
    SAVE_PATH = os.path.join(os.path.dirname(__file__), "..", "crowd_tracking_net25.pth")
    VIZ_DIR   = os.path.join(os.path.dirname(__file__), "..", "visualizations/25")
